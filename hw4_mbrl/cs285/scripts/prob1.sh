python cs285/scripts/run_hw4_mb.py \
    ...
    --num_agent_train_steps_per_iter 500 --n_layers 1 --size 32 \
...
python cs285/scripts/run_hw4_mb.py \
    ...
    --env_name cheetah-cs285-v0 \
    --add_sl_noise --n_iter 1 --batch_size_initial 20000 \
    --num_agent_train_steps_per_iter 5 --n_layers 2 --size 250 \
    --scalar_log_freq -1 --video_log_freq -1 \
    --mpc_action_sampling_strategy 'random'
python cs285/scripts/run_hw4_mb.py \
    ...
    --env_name cheetah-cs285-v0 \
    --add_sl_noise --n_iter 1 --batch_size_initial 20000 \
    --num_agent_train_steps_per_iter 500 --n_layers 2 --size 250 \
    --scalar_log_freq -1 --video_log_freq -1 \
    --mpc_action_sampling_strategy 'random'